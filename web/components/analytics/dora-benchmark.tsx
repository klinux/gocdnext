...
const ROWS: { metric: string; cells: [string, string, string, string] }[] = [
  { metric: "Deploy frequency", cells: ["on-demand", "1×dia–1×sem", "1×sem–1×mês", "< 1×mês"] },
  { metric: "Lead time", cells: ["< 1 dia", "1 dia–1 sem", "1 sem–1 mês", "> 1 mês"] },
  { metric: "Change failure rate", cells: ["0–15%", "16–30%", "31–45%", "> 45%"] },
  { metric: "Time to restore", cells: ["< 1 hora", "< 1 dia", "< 1 sem", "> 1 sem"] },
];
