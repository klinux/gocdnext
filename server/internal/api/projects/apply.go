...
type Handler struct {
	...
	// secretSourcesFn reports the external backends enabled on this server
	// (#54), live (hot-reloaded) — for the project secrets UI dropdown +
	// write validation. nil = none configured.
	secretSourcesFn func() []string
