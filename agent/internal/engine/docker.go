...
func (d *Docker) CleanupRunServices(_ context.Context, _ string, _ int64, _ func(ServiceLifecycleEvent)) (int, error) {
	return 0, nil
}

func (d *Docker) EnsureServices(ctx context.Context, services []ServiceSpec, runID, jobID string, _ int64, log func(stream, text string), onLifecycle func(ServiceLifecycleEvent)) (ServicesWireup, error) {
